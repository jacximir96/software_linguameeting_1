            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-4 mb-3 border-bottom-inst">
                        ...
                        <a class="a-title text-corporate-color" href="{{route('get.common.conversation_guide.chapter.file.downloadAllChapter', $conversation->id)}}"><u>Download all</u></a>
                    </div>
                    ...
                    @if ($chapterItem->conversation_guide_id === $conversation->id)
                        <div class="row mb-2">
                            <div class="col-md-10 text-corporate-color">
                                <u><a href="{{route('get.common.conversation_guide.chapter.file.showChapter', $chapterItem->id)}}" target="_blank">{{ $chapterItem->name }}</a></u>
                            </div>
                            <div class="col-md-2">
                                <div class="cursor_pointer">
                                    <a href="{{route('get.common.conversation_guide.chapter.file.downloadChapter', $chapterItem->id)}}">
