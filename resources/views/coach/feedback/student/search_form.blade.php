{{ Form::model($searchForm->model(),  [
    ...
    <div class="row gx-3 mb-3">
        ...
        <div class="col-4 col-md-3 col-xl-2">
            <label class="small mb-1 fw-bold @error('stars') text-danger @enderror" for="stars">Stars</label>
            <div class="form-group row">
                <div class="col-12">
        ...
        <div class="col-4 col-md-3 col-xl-2">
            <label class="small mb-1 fw-bold @error('favorite') text-danger @enderror" for="favorite">Favorite</label>
            <div class="form-group row">
                <div class="col-12">
                    {{Form::select('favorite', $searchForm->fieldWithOptions('favoriteOptions'), null,
                    [   'class'=>'form-control form-select',
                        'placeholder' => 'All',
                        'id' => 'favorite',
                        ])}}
