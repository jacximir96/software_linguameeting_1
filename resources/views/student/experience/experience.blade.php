...
<div class="row gx-0 p-3 mb-4 border rounded shadow-sm">
    <div class="col-12 col-md-7">
        ...
        <div class="row">
            <div class="col-12">
                <i class=" fa fa-calendar-day fa-fw text-corporate-color me-2"></i>
                <span class="fw-bold">
            ...
            <div class="col-12 mt-3 d-flex justify-content-between">
                ...
                <div>
                    ...
                    @if ($experience->userIsRegistered($student))
                        ...
                        @else {{-- register and past --}}
                            ...
                            @if ($experience->userAttendance($student))
                                ...
                                <a href="{{route('get.student.experience.comment.create', $experience->hashId())}}"
