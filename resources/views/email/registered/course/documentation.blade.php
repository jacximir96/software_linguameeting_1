            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td bgcolor="#ffffff" align="left" style="padding: 5px 30px 5px 30px; color: #404040;  font-weight: 400; line-height: 25px;">
                        ...
                        <br>
                        <div style="text-align:center;">Here you will find next steps and helpful resources for you and your students to ensure a smooth semester.</strong></div>
                        <br>
                ...
                <tr>
                    <td bgcolor="#ffffff" align="left" style="padding: 5px 30px 5px 30px; color: #404040;  font-weight: 400; line-height: 25px;">
                        ...
                        <div style="text-align:center; font-size:18px;"><strong>A list of useful faculty and student resources are included below:</strong></div>

                        <p><strong>Resources for Faculty and Students</strong></p>
                        <ol>
                            ...
                            <li>
                                <a href="https://www.dropbox.com/s/tudu0fu1oya81a5/LinguaMeeting_Manual_Faculty.pdf?dl=0">
                ...
                <tr>
                    <td bgcolor="#ffffff" align="left" style="padding: 5px 30px 5px 30px; color: #404040;  font-weight: 400; line-height: 25px;">
                        ...
                        @else
                            <p>Please feel free to reach out to our team at <a href="mailto:support@linguameeting.com">support@linguameeting.com</a> or directly back to this email if any questions may
