...
<table border="0" align="left" cellpadding="1" cellspacing="0" width="100%">
    <tr>
        <td align="left" class="w-50" width="30%">
            <p class="p-info mb-10">
                <span class="text-corporate-dark-color bold">Nombre</span>
                <br>
        ...
        <td width="30%">
            <p  class="p-info mb-10">
                <span class="text-corporate-dark-color bold">Lenguaje</span>
                <br>
        ...
        <td width="30%">
            <p  class="p-info mb-10">
                <span class="text-corporate-dark-color bold">Fecha</span>
                <br>
                {{$wrapper->printMoment()}}
            </p>
        </td>
    ...
    <tr>
        ...
        <td colspan="3">
            <p  class="p-info">
                <span class="text-corporate-dark-color bold">Grabación</span>
