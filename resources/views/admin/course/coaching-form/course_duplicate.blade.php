...
<!--                             {{Form::select('semester_id', $form->optionsField('semesterOptions'),null, [
                                ...
                                @foreach ($semesters as $semester)
                                    <option value="{{ $semester->id }}" {{ ( $semester->id == $term_activeCourse) ? 'selected' : '' }}> {{ $semester->name }} </option>
                                @endforeach
                                </select>
                            @error('semester_id')
...
<!--                             {{Form::select('year', $form->optionsField('yearsOptions'),null, [
                                ...
                                @foreach ($arrayYears as $arrayYear)
                                    <option value="{{ $arrayYear }}" {{ ($arrayYear == $year_activeCourse) ? 'selected' : '' }}> {{ $arrayYear }} </option>
                                @endforeach
                                </select>
                            @error('year')
                            <span class="custom-invalid-feedback" role="alert">
                        ...
                        <div class="col-sm-6 col-xl-4">
                            ...
                            @if ($allowsFullEdition)
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="start_date" name="start_date" value="{{$startDate_activeCourse}}">
                            ...
                            @else
                                <div class="card">
                                    <div class="card-body bg-light p-2">
                                        <span class="fst-italic">{{$startDate_activeCourse}}</span>
                        ...
                        <div class="col-sm-6 col-xl-4 offset-xl-1 mt-3 mt-sm-0">
                            ...
                            @if ($allowsFullEdition)
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="end_date" name="end_date" value="{{$endDate_activeCourse}}">
                                    <span class="input-group-text icon-calendar"><i class="fa fa-calendar"></i></span>
                                </div>
                            ...
                            @else
                                ...
                                <div class="card">
                                    <div class="card-body bg-light p-2">
                                        <span class="fst-italic">{{$endDate_activeCourse}}</span>
                                        <i class="fa fa-lock fa-fw subtitle-color small" title="Since your course already has students registered, some fields of the coaching form are locked"></i>
                                    </div>
                                </div>
