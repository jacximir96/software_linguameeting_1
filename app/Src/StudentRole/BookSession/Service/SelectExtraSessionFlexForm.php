...
class SelectExtraSessionFlexForm extends BaseSearchForm
{
    ...
    public function buildAction(FreeSlot $freeSlots): Url
    {
        ...
        $route = route('post.student.session.book.extra_session.store', ['enrollment' => $this->enrollment->hashId(), $this->sessionOrder->get()]);
