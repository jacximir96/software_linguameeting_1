...
class OneOnOneWeekForm extends BaseSearchForm
{
    ...
    {
        $this->action = route('post.admin.course.coaching_form.course_assignment.update.week.one_on_one', $course);
        ...
        foreach ($course->section as $section) {
            foreach ($section->assignment as $assignment) {
                ...
                if ($assignment->chapter) {
                    $key = $section->id.'-'.$assignment->week_id;
