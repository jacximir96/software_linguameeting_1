...
class SectionInformationForm extends BaseSearchForm
{
    ...
    {
        return route('get.admin.course.coaching_form_experiences.create.update.academic_dates', $this->course);
    }
    ...
    private function initialize(Course $course, User $user)
    {
        ...
        $this->action = route('post.admin.course.coaching_form_experiences.section_information', $course);
    }
