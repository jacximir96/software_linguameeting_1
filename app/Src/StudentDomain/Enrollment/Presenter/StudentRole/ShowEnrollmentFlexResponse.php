...
use App\Src\StudentDomain\Enrollment\Service\SessionsFlexBag;
use App\Src\StudentDomain\Enrollment\Service\SessionsWeeksBag;
use App\Src\UserDomain\User\Model\User;
use Illuminate\Support\Collection;

class ShowEnrollmentFlexResponse
{
    ...
    private SessionsFlexBag $sessionsBag;
    ...
    public function __construct (Enrollment $enrollment,
                                 ...
                                 SessionsFlexBag $sessionsBag,
                                 Collection $extraSessionsAvailable,
    ...
    public function sessionsBag ():SessionsFlexBag{
