...
namespace App\Http\Controllers\Api\Coach\Calendar\Event;

use App\Http\Controllers\Controller;
use App\Src\CoachDomain\Calendar\Presenter\CalendarEventByDayPresenter;
use App\Src\CoachDomain\Calendar\Presenter\CalendarEventByMonthPresenter;
use App\Src\CoachDomain\Calendar\Presenter\CalendarEventByWeekPresenter;
use App\Src\CoachDomain\Calendar\Presenter\CalendarSetup;
...
class GetEventController extends Controller
{
    ...
    public function __invoke(User $coach, string $startDate, string $endDate, string $gridType = 'dayGridMonth')
    {
        try {
            ...
            $scheduleResponse = $presenter->handle($coach, $period, $calendarSetup);
